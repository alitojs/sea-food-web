...
<script lang="ts">
  ...
  import {getBpmFormSchema,productSpecificationColumns} from '../ProductInfo.data';
  ...
  export default defineComponent({
    ...
    setup(props){
      ...
      async function initFormData(){
        ...
        requestSubTableData(productSpecificationList, {id: data.id}, productSpecificationTable, ()=>{
