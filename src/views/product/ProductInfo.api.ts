...
enum Api {
  list = '/storeProduct/storeProductInfo/queryProductListByStoreId',
 ...
 * @param params
 */
export const productSpecificationList = (params) => defHttp.get({ url: Api.productSpecificationList, params }, { isTransformResponse: false });
